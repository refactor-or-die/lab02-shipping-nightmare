...
class StandardShipping(Calculator):

    def calculate(self,package, distance, customer_type):
        base_cost = base_rates["standard"]
    ...
    def calculate(self,package, distance, customer_type):
        ...
        if package.weight > 15:
            return {
                "cost": None,
                "delivery_date": None,
                "info": "nie obsługuje paczek po 15kg"
            }
...
class SameDayCalculator(Calculator):
    def calculate(self,package, distance, customer_type):
        if distance > 50:
            return {
                "cost": None,
...
class EconomyCalculator(Calculator):
    def calculate(self,package, distance, customer_type):
        base_cost = base_rates["economy"]
...
class InternationalStandardCalc(Calculator):
    def calculate(self,package, distance, customer_type):
        base_cost = base_rates["international_standard"]
...
class LockerCalc(Calculator):
    def calculate(self,package, distance, customer_type):
        base_cost = base_rates["locker"]
...
class ShippingCalculator:
    ...
    def __init__(self):
        ...
        self.strategies: Dict[str, Calculator] = {
            "standard": StandardShipping(),
            "express": ExpressShipping(),
            "same_day": SameDayCalculator(),
            "economy": EconomyCalculator(),
            "international_standard": InternationalStandardCalc(),
            "drone": DroneCalc(),
            "locker": LockerCalc()
        }
